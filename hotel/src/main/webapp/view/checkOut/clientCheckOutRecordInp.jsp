            ...
            <div class="main-right  col-md-10 col-md-offset-2 bodys">
                        <div class="panel-body navs">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="${pageContext.request.contextPath}/showAllClientCheckOut/1">普通客户退房记录</a></li>
                                <li><a href="#">${requestScope.roomNumber}房普通客户退房记录</a></li>
                            </ol>
                        </div>            
          	<div class="col-md-12">
                    <div class="panel panel-default tableTitle">
                        <div class="panel-heading">
                          	搜索记录：
                          	<form action="${pageContext.request.contextPath}/showInputClientCheckOut/1" method="post">  
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered tb-hover">
                                ...
                                <tbody>
                                	<c:if test="${requestScope.checkOuts.size() >0}">
                                	<c:forEach items="${requestScope.checkOuts}" var="checkOuts">
                                    <tr class="users">                                                                
                                        <td class="userRealName">${checkOuts.roomNumber}</td>
                                        <td class="userVipId">${checkOuts.clientName}</td>
                                        <td class="userIdCard">${checkOuts.clientIdCard}</td>                                        
                                        <td class="userPhone">${checkOuts.clientPhone}</td>
                                        <td class="userPhone">${checkOuts.checkOutTime}</td>
                                        <td class="userPhone">${checkOuts.amountReceived}</td>
                                        <td class="userPhone">${checkOuts.staffName}</td>
                                        <td class=" text-center">
                                        <a href="#"><i title="查询详情" id="${checkOuts.checkOutId}" class="glyphicon glyphicon-search openReservationDetail"></i>
                                        </a>
                                        	 &nbsp;&nbsp;<a href="#"><i title="修改记录" id="${checkOuts.checkOutId}"  class="glyphicon glyphicon-edit openUpdateReservation"></i></a>                                       
                                       
                                        &nbsp;&nbsp;<i title="删除记录"  id="${checkOuts.checkOutId}" class="glyphicon glyphicon-remove openDeleteReservation"></i></td>
                                    </tr>
                                    </c:forEach>
                                    </c:if>
                                </tbody>
                        ...
                        <div class="panel-body spligs">
                            <nav>
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showInputClientCheckOut/${requestScope.nowPage -1}" aria-label="Previous">
							    ...
							    <li>				    		                       
							    <a style="background:#e7e7e7" href="/showInputClientCheckOut/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							     <c:if test="${requestScope.nowPage != showPage}">	 
							    <li>				    		                       
							    <a href="/showInputClientCheckOut/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							    </c:forEach>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showInputClientCheckOut/${requestScope.nowPage +1}" aria-label="Next">
