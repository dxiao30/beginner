                    ...
                    <div class="panel panel-default tableTitle">
                        <div class="panel-heading">
                          	...
                          	<form action="${pageContext.request.contextPath}/showInputAllClient/1" method="post">  
                       		<div class="input-group shouUsers">       
                                    ...
                                    <input type="text" class="form-control shouUsersInp" name="clientName" value="${requestScope.clientNames}" placeholder="请输入会员名、账号、手机号、身份证号" />
                            ...
                            <table class="table table-bordered tb-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="client">                                                                
                                        ...
                                        <a href="#"><i title="查询消费记录" id="${clients.clientId}" class="glyphicon glyphicon-search openShowAnnouncement"></i>
                        ...
                        <div class="panel-body spligs">
                            <nav>
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showInputAllClient/${requestScope.nowPage -1}" aria-label="Previous">
							    ...
							    <li>				    		                       
							    <a style="background:#e7e7e7" href="/showInputAllClient/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							     <c:if test="${requestScope.nowPage != showPage}">	 
							    <li>				    		                       
							    <a href="/showInputAllClient/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							    </c:forEach>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showInputAllClient/${requestScope.nowPage +1}" aria-label="Next">
