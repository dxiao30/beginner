            ...
            <div class="main-right  col-md-10 col-md-offset-2 bodys">
                        <div class="panel-body navs">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="${pageContext.request.contextPath}/showAllUsers/1">所有预订记录</a></li>
                                <li><a href="${pageContext.request.contextPath}/showAllUsers/1">搜索预订记录</a></li>
                            </ol>
                        </div>            
          	<div class="col-md-12">
                    <div class="panel panel-default tableTitle">
                        <div class="panel-heading">
                          	...
                          	<form action="${pageContext.request.contextPath}/showInputReservation/1" method="post">  
                       		<div class="input-group shouUsers">       
                                    ...
                                    <input type="text" class="form-control shouUsersInp" name="userRealName" value="${requestScope.roomNumbers}" placeholder="请输入房间号..." />
                            ...
                            <table class="table table-bordered tb-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="users">                                                                
                                        ...
                                        </a>&nbsp;&nbsp;<a href="#"><i title="修改记录" id="${reservations.reservationId}"  class="glyphicon glyphicon-edit openUpdateReservation"></i></a>
                        ...
                        <div class="panel-body spligs">
                            <nav>
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showInputReservation/${requestScope.nowPage -1}" aria-label="Previous">
							    ...
							    <li>				    		                       
							    <a style="background:#e7e7e7" href="/showInputReservation/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							     <c:if test="${requestScope.nowPage != showPage}">	 
							    <li>				    		                       
							    <a href="/showInputReservation/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							    </c:forEach>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showInputReservation/${requestScope.nowPage +1}" aria-label="Next">
                      ...
                      <div class="panel-body">
                          ...
                          <input type="hidden" name="roomId" class="roomIdInp">
                         	 <div class="form-group newRoomTypeInp">
                                  ...
                                  <input type="text" class="form-control roomNumberDetail"/>                             
                              </div>
                              <div class="form-group newRoomTypeInp">
                              ...
                              <div class="form-group newRoomTypeInp">
                                  ...
                                  <input type="text" name="reservationTime" class="form-control reservationTimeDetail"/>
                                  
                              </div>
                              <div class="form-group newRoomTypeInp">
                                  <label for="exampleInputEmail1">预计到店时间</label>
                                  <input type="text" name="expectedTimeOfArrival"  class="form-control expectedTimeOfArrivalDetail" />
                              </div>
                              <div class="form-group newRoomTypeInp">
                                  <label for="exampleInputEmail1">预订状态</label>
                                 <input type="text" name="expectedTimeOfArrival"  class="form-control reservationStatusDetail" />
                              </div>
                              <div class="form-group newRoomTypeInp">
                              ...
                              <div class="form-group newRoomTypeInp">
                                  ...
                                  <input type="text" name="reservationForegift" class="form-control unsubscribeForegiftDetail"/>
                              </div>                          
               ...
               <div class="col-md-6 updateReservation">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="reservationId" class="reservationIdInp">
                            ...
                            <div class="form-group newRoomTypeInp">
                                <label for="exampleInputEmail1">预订时间</label>
                                <input type="text"  class="form-control reservationTimeDetail"/>
                            ...
                            <div class="form-group newRoomTypeInp">
                                <label for="exampleInputEmail1">已退押金</label>
                                <input type="text"  class="form-control unsubscribeForegiftDetail"/>
                            </div>                          
                            <div class="newRoomTypeFooter">
