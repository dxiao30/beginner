            ...
            <div class="main-right  col-md-10 col-md-offset-2 bodys">
                        <div class="panel-body navs">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="#">${userConsumptionRecords.userRealName}的消费记录</a></li>
                                </c:forEach>
                                <c:set var="a" value="2"/>
                                </c:if>
                                </c:if>
                    ...
                    <div class="panel panel-default tableTitle">
                        ...
                        <div class="panel-body spligs">
                            <nav>
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showUsersIdConsumptionRecord/${requestScope.nowPage -1}&${requestScope.usersId}" aria-label="Previous">
							    ...
							    <li>				    		                       
							    <a style="background:#e7e7e7" href="/showUsersIdConsumptionRecord/${showPage}&${requestScope.usersId}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							     <c:if test="${requestScope.nowPage != showPage}">	 
							    <li>				    		                       
							    <a href="/showUsersIdConsumptionRecord/${showPage}&${requestScope.usersId}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							    </c:forEach>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showUsersIdConsumptionRecord/${requestScope.nowPage +1}&${requestScope.usersId}" aria-label="Next">
