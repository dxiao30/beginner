                    ...
                    <div class="panel panel-default tableTitle">
                        <div class="panel-heading">
                          	...
                          	<form action="${pageContext.request.contextPath}/showAllUsersIdConsumptionRecord/1" method="post">  
                       		<div class="input-group shouUsers">       
                                    ...
                                    <input type="text" class="form-control shouUsersInp" name="userRealName" value="${requestScope.userRealNames}" placeholder="请输入会员名、账号、身份证号、手机号..." />
                        ...
                        <div class="panel-body spligs">
                            <nav>
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showAllUsersIdConsumptionRecord/${requestScope.nowPage -1}" aria-label="Previous">
							    ...
							    <li>				    		                       
							    <a style="background:#e7e7e7" href="/showAllUsersIdConsumptionRecord/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							     <c:if test="${requestScope.nowPage != showPage}">	 
							    <li>				    		                       
							    <a href="/showAllUsersIdConsumptionRecord/${showPage}">${showPage}</a>				    			    
							    </li>
							    </c:if>	
							    </c:forEach>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/showAllUsersIdConsumptionRecord/${requestScope.nowPage +1}" aria-label="Next">
